...
const contactContent = () => {
  const htmlMap = `<div class="map-container tab-fade"><div class="map" id='map'></div></div>`;
  ...
  const htmlImage = `<div class="contact__img--container tab-fade"><img src="./img/Royston.jpg" alt="Welcome to royston vasey" class="contact__img"></div>`;
